...
// The IllnessQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type IllnessQueryRuleFunc func(context.Context, *ent.IllnessQuery) error

// EvalQuery return f(ctx, q).
func (f IllnessQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.IllnessQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.IllnessQuery", q)
}

// The IllnessMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type IllnessMutationRuleFunc func(context.Context, *ent.IllnessMutation) error

// EvalMutation calls f(ctx, m).
func (f IllnessMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.IllnessMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.IllnessMutation", m)
}
...
// The SymptomsQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type SymptomsQueryRuleFunc func(context.Context, *ent.SymptomsQuery) error

// EvalQuery return f(ctx, q).
func (f SymptomsQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SymptomsQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.SymptomsQuery", q)
}

// The SymptomsMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type SymptomsMutationRuleFunc func(context.Context, *ent.SymptomsMutation) error

// EvalMutation calls f(ctx, m).
func (f SymptomsMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.SymptomsMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.SymptomsMutation", m)
}
