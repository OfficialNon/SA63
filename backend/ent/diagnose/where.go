...
func HasSymptoms() predicate.Diagnose {
	return predicate.Diagnose(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(SymptomsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, SymptomsTable, SymptomsColumn),
		)
...
func HasSymptomsWith(preds ...predicate.Symptoms) predicate.Diagnose {
	return predicate.Diagnose(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasIllness applies the HasEdge predicate on the "illness" edge.
func HasIllness() predicate.Diagnose {
	return predicate.Diagnose(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(IllnessTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, IllnessTable, IllnessColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasIllnessWith applies the HasEdge predicate on the "illness" edge with a given conditions (other predicates).
func HasIllnessWith(preds ...predicate.Illness) predicate.Diagnose {
	return predicate.Diagnose(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(IllnessInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, IllnessTable, IllnessColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
